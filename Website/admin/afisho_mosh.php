...
<body>
<form action = "afisho_mosh.php" method = "post">
<input type="text" name="age" placeholder="Mosha Minimale">
<input type="text" name="age1" placeholder="Mosha Maksimale" >
<button type = "submit_age" name = "submit_age">Kerko</button>
</form>
<br>
<br>
