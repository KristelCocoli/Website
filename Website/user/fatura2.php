<?php
include('../server.php');//se sjane nje file
...
$pdf->Cell(34	,5, rand(100000,999999),0,1);//end of line gjenero nje nr rastesor me 6 shifra qe cdo fature te kete nr te vecante 6 shifra
...
$pdf->Cell(130	,5,'Parabellum Prepare to Die Edition',1,0);
$pdf->Cell(25	,5,'-',1,0);
$pdf->Cell(34	,5,'39.99$',1,1,'R');//end of line

//summary
$pdf->Cell(130	,5,'',0,0);
$pdf->Cell(25	,5,'Subtotal',0,0);
$pdf->Cell(4	,5,'$',1,0);
$pdf->Cell(30	,5,'43.989$',1,1,'R');//end of line

$pdf->Cell(130	,5,'',0,0);
$pdf->Cell(25	,5,'Taxable',0,0);
$pdf->Cell(4	,5,'$',1,0);
$pdf->Cell(30	,5,'3.999$',1,1,'R');//end of line
